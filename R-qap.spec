...
Version  : 0.1.2
Release  : 56
URL      : https://cran.r-project.org/src/contrib/qap_0.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/qap_0.1-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737154526
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/qap/libs/qap.so
/V4/usr/lib64/R/library/qap/libs/qap.so
